...
def boosted_reference(planeList):
    ...
    for ind,pl in enumerate(planeList):
        ...
        rayRGB[intersectingRayInds] = pl.plane_colour# boostedColor(rays[intersectingRayInds])
...
frames=[]
for vx in np.linspace(0,0.99,41):
...
gif.save(frames,'boosted-box-notemp.gif',duration=10,unit='s',between='startend')
